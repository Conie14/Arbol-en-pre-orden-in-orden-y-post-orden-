...
function recorridosHTML() {
  ...
  <table cellspacing=0 cellpadding=0 class="table table-dark table-striped" id="tabla_recorridos">
  <tbody>`;
  ...
  retorno += `<tr>`;
  retorno += `<td>Recorrido en pre-orden</td>`;
  ...
  retorno += `<tr>`;
  retorno += `<td>Recorrido en in-orden</td>`;
  ...
  retorno += `<tr>`;
  retorno += `<td>Recorrido en post-orden</td>`;
